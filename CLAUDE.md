...
├── uchenichestvo/
│   ├── TEMPLATE.md                    # Шаблон для конспектов ученичества
...
## Ученичество (Преображающее знакомство со Христом)
- Курс личного ученичества на основе книги Джонатана Д. Бёрнэма (Burnham Ministries International, 2020)
- Хранятся в `uchenichestvo/`, каждый файл – одна тема: `NN-название.md`
- Шаблон для новых/обновлённых конспектов: `uchenichestvo/TEMPLATE.md`
- Покрытие: 17 тем (Сотворение – Возвращение Царя)
- Структура каждого конспекта:
  1. `# Тема N: Название` – заголовок
  2. `Основной текст` – ключевой отрывок (Синодальный перевод)
  3. `Контекст` – место темы в сюжетной линии Библии
  4. `Часть 1. Объяснение темы` – разбор по разделам (темы 1–8)
  5. `Часть 2. Христологический взгляд` – связь с Христом (темы 1–8)
  6. Темы 10–17 (НЗ) – единая структура без деления на части
  7. `Вопросы для обсуждения` – 3–5 вопросов для личной встречи
  8. `Практические выводы` – применение
- Те же правила по цитатам из Библии и типографике
