...
├── draft/
│   └── <slug>.md                      # Черновики и прочие материалы (исследования, doc-разборы) – вкладка «Драфт»
...
- **Вкладки** «Проповеди» / «Луки» / «Драфт» (счётчик у каждой). «Драфт» – сборная папка `draft/` для черновиков и материалов, не попадающих в первые две (исследования, doc-разборы и т.п.)
